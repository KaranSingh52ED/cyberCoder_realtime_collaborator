...
import { Settings, SettingsContext as SettingsContextType } from '@/types/setting'
...
function SettingContextProvider({ children }: { children: ReactNode }) {
    ...
    const storedSettings: Partial<Settings> = JSON.parse(getItem('settings') || '{}')
    ...
    const storedFontFamily =
        storedSettings.fontFamily !== undefined ? storedSettings.fontFamily : defaultSettings.fontFamily
