...
export const findParentDirectory = (directory: FileSystemItem, parentDirId: Id): FileSystemItem | null => {
...
export const getFileById = (fileStructure: FileSystemItem, fileId: Id): FileSystemItem | null => {
